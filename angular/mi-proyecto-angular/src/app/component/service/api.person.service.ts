...
export class ApiPersonService {
  ...
  getData(): Observable<any> {
    ...
    return this.https.get<any>(`${this.apiUrl}/Persons`); // 👈 Aquí corriges
  }

  // GET: Obtiene un elemento por su ID
  getById(id: number): Observable<any> {
    return this.https.get<any>(`${this.apiUrl}/Persons/${id}`); // 👈 Corrige aquí también
  }

  // POST: Crea un nuevo elemento
  postData(data: any): Observable<any> {
    return this.https.post<any>(`${this.apiUrl}/Persons`, data); // 👈 Corrige aquí
  }

  // PUT: Actualiza un elemento
  putData(id: number, data: any): Observable<any> {
    return this.https.put<any>(`${this.apiUrl}/Persons/${id}`, data); // 👈 Corrige aquí
  }

  // DELETE: Elimina un elemento
  deleteData(id: number): Observable<any> {
    return this.https.delete<any>(`${this.apiUrl}/Persons/${id}`); // 👈 Corrige aquí
  }
